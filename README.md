...
2.  **Reinforce Handle:** **Stack and super glue** the gold handle pieces. Insert and glue **three steel support rods** into the central core for structural integrity.
...
3.  **Prepare Blade Supports:** **Glue** the two blade halves together along *one* edge. Insert **two steel support rods** into the hollow interior (one on each side of the center channel) and glue them securely to the plastic walls.
...
4.  **Attach Handle to Blade:** **Super glue** the reinforced handle assembly, including its steel rods, to the base of the open blade assembly.
...
5.  **Route LED Wire:** Pass the **LED strip's power cable** (the end nearest the battery pack/switch) through the dedicated small hole near the blade's base.
...
7.  **Final Closure:** Apply **super glue** to the remaining open edges and secure the **remaining blade half**, fully sealing the sword around the lights and supports. Hold firmly until the glue is set.
